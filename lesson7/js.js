 ...
 * @property {number} maxX Максимально возможная координата по X.
 * @property {number} maxY Максимально возможная координата по Y.
 */
const snake = {
    body: null,
    direction: null,
     ...
     * @param {int} maxX Максимальная координата по x.
     * @param {int} maxY Максимальная координата по y.
     */
    ...
    getNextStepHeadPoint() {
        ...
        switch (this.direction) {
            case 'up':
                // если голова упирается в верхнюю стенку
 ...
 * @property {score} score Очки пользователя.
